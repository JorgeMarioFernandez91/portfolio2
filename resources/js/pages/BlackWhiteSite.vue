<template>
  <div class="main">
    <nav class="nav" :class="navScrolled ? 'highlight' : ''">
      <ul>
        <li>Home</li>
        <li>About</li>
        <li>Products</li>
    ...
    <div class="master-header-gradient">
      <div class="content-container">
        ...
        <div class="btn-container">
          <div class="btn" @click="scrollToRef('projects')">Get Started</div>
        </div>
    ...
    <header class="master-header"></header>
    ...
    <div class="sign-up-gradient">
      ...
      <div class="title">Subscribe To Receive Updates</div>
      ...
      <section class="contact">
        <div class="standard-contact-container">
          <div class="address">
            <div class="widget">
            ...
            <div class="line"></div>
            <div class="text">1234 Real Street, Toronto ON</div>
          </div>
          <div class="email">
            <div class="widget">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
          ...
          <div class="phone">
            ...
            <div class="line"></div>
            <div class="text">{{ "+1 (555) 444-4321" }}</div>
          </div>
        </div>
    ...
    <footer class="footer">Copyright © Black & White 2022</footer>
  </div>
</template>
...
@import "resources/sass/black-white.scss";
</style>